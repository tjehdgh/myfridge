...
<%if(com.icia.web.util.CookieUtil.getCookie(request,"USER_ID") != null)//쿠키가 있을때(로그인 성공)
   {
%> 
                                <a href="/user/fridge" ><h5 style="color: skyblue;">나만의 냉장고</h5></a>
<% 
}
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <a href="/board/qna" ><h5 style="color: skyblue;">QnA</h5></a>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a class="btn btn-primary py-3 px-5 mt-2" href="/user/fridge">Try Out</a>
                    </div>
                </div>
            </div>
        </div>
